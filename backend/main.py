"""
Angular Scheduler 1 - Backend API
Angular employee scheduling app with shifts, leave management, and calendar
"""
...
app = FastAPI(
    title="Angular Scheduler 1",
    description="Angular employee scheduling app with shifts, leave management, and calendar",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "Angular Scheduler 1"}
